"""Localização da raiz do monorepo AiGameKit (sem dependência do Clified)."""
...
def find_monorepo_root(start: Path | None = None) -> Path:
    ...
    if found is not None:
        return found
    msg = "Raiz do monorepo AiGameKit não encontrada. Execute a partir de dentro do repositório."
