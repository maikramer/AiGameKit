...
Suporta:
- SDNQ (SD.Next Quantization) — centralized in ``aigamekit_shared.sdnq``
...
def is_sdnq_available() -> bool:
    ...
    from aigamekit_shared.sdnq import is_available as _sdnq_available
...
def get_quantization_config(
    ...
    if mode.startswith("sdnq"):
        from aigamekit_shared.sdnq import PRESETS, create_config
...
def get_suggested_quantization_for_vram(
    ...
    """
    from aigamekit_shared.sdnq import suggest_preset_for_vram
...
def apply_torch_compile(
    ...
    *,
    ...
    Args:
        ...
        offload: valor do :class:`~aigamekit_shared.lowvram.OffloadPlan.offload`
    ...
    if safe_mode != mode:
        ...
        logging.getLogger("aigamekit_shared.quantization").warning(
