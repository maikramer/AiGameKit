...
def resolve_skill_source(
    ...
    aigamekit = try_find_monorepo_root(package_dir)
    if aigamekit is not None:
        cand = aigamekit / ".cursor" / "create-skill" / tool_name
    ...
    raise FileNotFoundError(
        ...
        f"AiGameKit/.cursor/create-skill/{tool_name}/SKILL.md ou "
