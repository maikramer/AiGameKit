"""Unified progress protocol for AiGameKit CLI tools.
...
Usage in sub-tools::
    ...
    from aigamekit_shared.progress import emit_progress, emit_result
...
Usage in orchestrator::
    ...
    from aigamekit_shared.progress import parse_progress_line
