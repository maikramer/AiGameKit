...
4. wrap final com ``with_vramd_peak_opts(with_vramd_load_opts(payload, gpu_ids=…))``
...
def build_request_body(
    *,
    ...
    """Monta o corpo de um request vramd de geração.
    ...
    Returns:
        Dict pronto para o wrap com ``with_vramd_peak_opts``/``with_vramd_load_opts``.
    """
