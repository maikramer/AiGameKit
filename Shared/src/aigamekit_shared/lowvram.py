...
- :func:`apply_offload_plan` — aplica o plano ao pipeline diffusers chamando as
  primitivas já existentes em :mod:`aigamekit_shared.quantization` (um único sítio, em vez
...
def get_footprint(key: str) -> ModelFootprint:
    ...
    logging.getLogger("aigamekit_shared.lowvram").warning(
...
def apply_offload_plan(
    ...
    *,
    ...
    :class:`~aigamekit_shared.multi_gpu.MultiGPUPlanner`). Trata só do passo de
...
def apply_multi_gpu(
    ...
    *,
    ...
    :class:`~aigamekit_shared.multi_gpu.MultiGPUPlanner` que usa
