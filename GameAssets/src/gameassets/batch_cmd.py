                    ...
                    if not skip_text2d and any_texture2d_row and texture2d_bin:
                        ...
                        if tex_items_d:
                            ums_tex = run_texture2d_wave_or_fallback(
                                ...
                                steps=int(tt_wave.steps or 28),
                                guidance=float(tt_wave.guidance_scale or 7.0),
                                quality=profile.generation,
                    ...
                    if not skip_text2d and any_texture2d_row and texture2d_bin:
                        ...
                        if tex_items_p:
                            ums_tex_p = run_texture2d_wave_or_fallback(
                                ...
                                steps=int(tt_wave_p.steps or 28),
                                guidance=float(tt_wave_p.guidance_scale or 7.0),
                                quality=profile.generation,
