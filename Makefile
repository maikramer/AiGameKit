...
PYTHON_PROJECTS := Shared Text2D Text2Icon Text3D Paint3D Part3D GameAssets Texture2D Text2Sound GameDevLab Terrain3D Rocks3D
...
test-rocks3d: ## pytest only in Rocks3D/
	$(call run-pytest,Rocks3D)
