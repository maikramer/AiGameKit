...
_HEADER: Final = "[bold cyan]Motion3D[/bold cyan] — text-to-motion · Motius T2M-GPT HumanML3D"
_FOOTER: Final = "[dim]README · HF Motius weights · UMS · bpy GLB · motion3d doctor[/dim]"
