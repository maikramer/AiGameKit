...
const CFG_CLOCK_START: f32 = 600;
const CFG_CLOCK_SPEED: f32 = 0;
...
fn fragment(
    ...
    // pelo fresnel, e a espuma por cima de tudo. `wave_tint`/`streak` dão
    // variação difusa (cristas/correnteza) que sobrevive a céu encoberto.
