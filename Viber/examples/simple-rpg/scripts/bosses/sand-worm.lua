-- bosses/sand-worm.lua: comportamento portado do TS (a engine provê os blocos: percepção,
-- movimento com snap no terreno, máquina wander/chase, dano).
local SPEED_WANDER, SPEED_CHASE = 1.2, 4.0
local AGGRO, DEAGGRO, ATTACK_RANGE = 12, 17, 2.6
local DAMAGE, COOLDOWN = 20, 2.0
