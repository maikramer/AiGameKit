...
**Text-to-3D** em duas fases: **[Text2D](../Text2D)** (texto → imagem) e **[Hunyuan3D-Omni](https://huggingface.co/tencent/Hunyuan3D-Omni)** (imagem → mesh + controlos bbox/pose/point/voxel; SDNQ INT4 em GPUs pequenas). O modelo 2D é **sempre descarregado** antes de carregar o Omni.
