...
class TestMapUmsLoadKwargs:
    def test_torch_compile_alias(self) -> None:
        kw = map_ums_load_kwargs({"torch_compile": True, "torch_compile_mode": "reduce-overhead"})
