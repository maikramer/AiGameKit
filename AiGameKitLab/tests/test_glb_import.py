"""Tests for aigamekit_lab.glb_import — decode-aware GLB import wiring."""
...
class TestImportGlb:
    def test_imports_decoded_path(self, tmp_path):
        ...
        with (
            ...
            patch("aigamekit_shared.gltf_decode.bpy_readable_glb", fake_readable),
        ):
            import_glb(src)
    ...
    def test_renderer_and_debug_tools_use_import_glb(self):
        ...
        import aigamekit_lab.cut_review as cut_review
        import aigamekit_lab.debug_tools as debug_tools
        import aigamekit_lab.renderer as renderer
