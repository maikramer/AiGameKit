...
from aigamekit_lab.mesh_inspector import (
    ArtifactReport,
    GeometryReport,
    MeshInspector,
    MeshQAReport,
...
class TestRenderViews:
    def test_render_failure_returns_empty(self) -> None:
        ...
        try:
            inspector = MeshInspector(path)
            with patch("aigamekit_lab.renderer.render_screenshots", side_effect=RuntimeError("bpy error")):
    ...
    def test_render_views_calls_screenshot(self) -> None:
        ...
        try:
            ...
            with patch("aigamekit_lab.renderer.render_screenshots") as mock_render:
