"""
Otimizador SDNQ avançado para AiGameKitLab.
...
Quantization presets are sourced from ``aigamekit_shared.sdnq``.
"""
...
from aigamekit_shared.sdnq import create_config as create_sdnq_config_shared
...
def apply_paint3d_with_sdnq_opt(
    ...
    try:
        ...
        from aigamekit_shared.vram_monitor import VRAMMonitor
