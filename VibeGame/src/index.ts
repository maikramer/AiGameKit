...
export { fitModel, measureModelAxis } from './extras/model-fit';
export type { FitModelOptions, ModelAxis } from './extras/model-fit';
...
export type { InstancedGltfSpawn } from './plugins/gltf-xml';
...
export type { LoadingScreenLocale, LoadingScreenText } from './plugins/loading';
export {
...
export {
  ...
  clearGroundBrushes,
  crownHitsFlyingDeck,
  // Corridor helpers — games that author a carve (race circuits, canals) need
  // to map their own per-node design lists onto the stamped polyline.
  resampleNodeValues,
  pathArcs,
  nearestOnPolyline,
