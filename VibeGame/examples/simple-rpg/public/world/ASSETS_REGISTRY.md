...
| id               | paths (lod0→collision)                                                                                                                                                                                                        | região sugerida  | XML hoje   | size_m                  | notas                                      |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ---------- | ----------------------- | ------------------------------------------ |
| `hero`           | `/assets/meshes/characters/hero_lod0.glb`<br>`/assets/meshes/characters/hero_lod1.glb`<br>`/assets/meshes/characters/hero_lod2.glb`<br>`/assets/meshes/characters/hero_collision.glb`                                         | Global           | GLTFLoader | 0.55×1.55×0.4 m (L×H×W) | coll=sim; index.html PlayerGLTF            |
