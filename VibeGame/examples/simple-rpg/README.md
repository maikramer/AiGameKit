...
| Plaza campfire                             | Entity script                            | `<GameObject name="campfire" script="campfire.ts">` (press **G** — rest + travel to marked Nota landmarks)                 |
