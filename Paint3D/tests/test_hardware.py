...
def test_rtx4050_6gb_gets_low_vram() -> None:
    """RTX 4050 6GB → SDNQ uint8, 6v@512, render 1024, tex 2048.

    Envelope de ouro do modo mem-eff: malhas 280-320k faces levam o
    raster/bake a ~5.7 GiB — o antigo 1536/3072 estourava (OOM-spin).
    """
