"""Suite de cobertura Text2D (ums_payload, ums_load, hardware, CLI) sem GPU/HF.
...
def test_ums_payload_defaults_prompt_output() -> None:
...
def test_ums_payload_default_width_height() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_default_steps_guidance() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_seed_none_by_default() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_seed_explicit() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_model_id_omitted_when_none() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_model_id_set() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_gpu_ids_list() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_gpu_ids_string_csv() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_gpu_ids_empty_string_ignored() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_quant_preset_maps_sdnq() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_quant_none_string() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_memory_efficient_false_default() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_memory_efficient_true() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_torch_compile_default_off() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_torch_compile_on() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_torch_compile_mode_optional() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_torch_compile_mode_omitted() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_channels_last_default_false() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_channels_last_true() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_step_cache_set() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_step_cache_omitted() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_extra_merged() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_footprint_key() -> None:
    from text2d.ums_payload import build_generate_request
...
def test_ums_payload_coerces_numeric_types() -> None:
    from text2d.ums_payload import build_generate_request
...
# --- map_ums_load_kwargs (extra além de test_ums_load.py) ---
...
def test_map_load_sdnq_null_becomes_none_quant() -> None:
    ...
    out = map_ums_load_kwargs({"sdnq_preset": "null"})
...
def test_map_load_sdnq_empty_string_becomes_none_quant() -> None:
    ...
    out = map_ums_load_kwargs({"sdnq_preset": ""})
    assert out["quant_preset"] is None
...
def test_map_load_quant_preset_null_cleared() -> None:
    ...
    out = map_ums_load_kwargs({"quant_preset": "NULL"})
    assert out["quant_preset"] is None
...
def test_map_load_quant_preset_wins_over_missing_sdnq() -> None:
    ...
    out = map_ums_load_kwargs({"quant_preset": "sdnq-fp8"})
...
def test_map_load_strips_offload_keys() -> None:
    ...
    out = map_ums_load_kwargs({"offload": "cpu", "allow_group_offload": True, "quant_mode": "int4"})
...
def test_map_load_memory_efficient_none_becomes_false() -> None:
    ...
    out = map_ums_load_kwargs({"memory_efficient": None})
...
def test_map_load_preserves_unrelated_keys() -> None:
    ...
    out = map_ums_load_kwargs({"prompt": "x", "width": 1024})
    assert out["prompt"] == "x"
...
def test_map_load_does_not_overwrite_explicit_quant_when_sdnq_set() -> None:
    ...
    out = map_ums_load_kwargs({"quant_preset": "sdnq-int4", "sdnq_preset": "sdnq-uint8"})
